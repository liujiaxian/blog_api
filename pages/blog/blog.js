...
Page({
  ...
  onLoad: function (options) { 
    ...
    var that = this
    wx.request({
      url: 'https://api.pqpqpq.cn/api/values/postbloglist?page=1&typeid='+this.data.typeid,
      headers: {
  ...
  pullUpLoad: function (e) {
    ...
    wx.request({
      url: 'https://api.pqpqpq.cn/api/values/postbloglist?page=' + this.data.page+"&typeid="+this.data.typeid,
      headers: {
        'Content-Type': 'application/json'
      },
      method: 'POST',
